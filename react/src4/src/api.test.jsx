...
const server = setupServer(
  http.get('https://jsonplaceholder.typicode.com/albums', (req, res, ctx) => {
    return res(
      ctx.json([
        { id: 1, title: 'Album 1' },
        { id: 2, title: 'Album 2' },
  ...
  http.get('https://jsonplaceholder.typicode.com/albums/:id', (req, res, ctx) => {
    const { id } = req.params;
    return res(
      ctx.json({ id: Number(id), title: `Album ${id}` })
    );
  }),
  http.post('https://jsonplaceholder.typicode.com/albums', async (req, res, ctx) => {
...
describe('API tests', () => {
  ...
  it('handles create error', async () => {
    server.use(
      http.post('https://jsonplaceholder.typicode.com/albums', (req, res, ctx) => {
